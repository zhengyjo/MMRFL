...
class CommonArgs(Tap):
    ...
    multi_modality_ensemble: str = 'False'
    """A flag to indicate whether we want to use a multiple modality ensemble model"""
...
#         self.encoder_path = encoder_path
    ...
    def configure(self) -> None:
        self.add_argument('--encoder_path', type=str)
