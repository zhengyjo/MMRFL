...
#encoder_paths_arr = ['smiles.pt','image.pt','nmr.pt','fusion_fingerprint.pt','fusion_nmr.pt'] 
...
arguments = [
    ...
    '--save_dir', '{}_test_checkpoints_multi_intermediate_CL'.format(data_dir_arr[-1][:-4]),
    '--epochs', '100',
