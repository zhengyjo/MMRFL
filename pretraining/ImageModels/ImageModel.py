...
class ImageEncoderInterface(nn.Module):
    def __init__(self,
                 model_load_pretrained='./pretraining/ImageModels/PretrainedWeights/model.ckpt',
                 ):
        super(ImageEncoderInterface, self).__init__()
        # self.model = Img2Mol()
        # self.model.load_from_checkpoint(model_load_pretrained)
        self.model = Img2Mol.load_from_checkpoint(model_load_pretrained)
